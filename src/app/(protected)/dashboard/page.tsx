  ...
  return (
    <div className="mx-auto max-w-7xl px-6 py-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        <Link
          href="/settings"
          className="group relative rounded-2xl border border-white/8 bg-white/[0.03] p-6 flex items-center gap-4 hover:border-brand-500/25 hover:bg-white/[0.06] transition-all duration-200 overflow-hidden"
        >
